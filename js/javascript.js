...
(function () {
    document.addEventListener('click', function (e) {
        ...
        e.stopPropagation();
        e.preventDefault();
        var newFiles = document.querySelectorAll('.createfile li');
        var menu = document.querySelector('.menu');
        var subMenu = document.querySelector('.submenu');
...
function getfileOffset(index) {
    ...
    var filesW = css(files[0], "width") * 1.1;
    var filesH = css(files[0], "height") * 1.1;

    var ceils = Math.floor(files[0].parentNode.clientHeight / filesH); //一竖列可以放几个
